...
# assistant env
def comparison_algorithm(checkpoint_dir, captured_dir):
    """
    ...
    if checkpoints.installed_ls:
        ...
        for i in range(len(checkpoints.checkpoint_ls)):
            ...
            for index in range(len(captured_xml_path_list)):
                ...
                if get_xml_fuzzy_match(checkpoint_xml_path, captured_xml_path):
                    ...
                    for k in range(len(exactly_checkpoint_list)):
                        ...
                        if exactly_match(checkpoint_dir, pic_id, keyword, node_id, captured_dir, index):
        ...
        matched_state = [checkpoint.matched for checkpoint in checkpoints.checkpoint_ls]
        ...
        if False in matched_state:
            ...
            # 升序
            capture_id_list = [int(checkpoint.capture_id) for checkpoint in checkpoints.checkpoint_ls]
...
if __name__ == "__main__":
    ...
    checkpoint_dir = "/data/jxq/mobile-agent/aitw_replay_data/general/trace_41"
    captured_dir = "/data/zzh/mobile-agent/Auto-UI/agentenv/captured_data/11823528658386431357"
